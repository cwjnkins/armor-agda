...
unambiguousRange space (numbers (fst , _)) =
  contradiction{P = 48 ≤ 32} fst (toWitnessFalse{a? = 48 ≤? 32} tt)
unambiguousRange space (uppers (fst , _)) =
  contradiction{P = 65 ≤ 32} fst (toWitnessFalse{a? = 65 ≤? 32} tt)
unambiguousRange space (lowers (fst , snd)) =
  contradiction{P = 97 ≤ 32} fst (toWitnessFalse{a? = 97 ≤? 32} tt)
unambiguousRange apostrophe apostrophe = refl
unambiguousRange apostrophe (numbers (fst , _)) =
  contradiction{P = 48 ≤ 39} fst (toWitnessFalse{a? = 48 ≤? 39} tt)
unambiguousRange apostrophe (uppers (fst , snd)) =
  contradiction{P = 65 ≤ 39} fst (toWitnessFalse{a? = 65 ≤? 39} tt)
unambiguousRange apostrophe (lowers (fst , snd)) =
  contradiction{P = 97 ≤ 39} fst (toWitnessFalse{a? = 97 ≤? 39} tt)
unambiguousRange leftParen leftParen = refl
unambiguousRange leftParen (numbers (fst , snd)) =
  contradiction{P = 48 ≤ 40} fst (toWitnessFalse{a? = 48 ≤? 40} tt)
unambiguousRange leftParen (uppers (fst , snd)) =
  contradiction{P = 65 ≤ 40} fst (toWitnessFalse{a? = 65 ≤? 40} tt)
unambiguousRange leftParen (lowers (fst , snd)) =
  contradiction{P = 97 ≤ 40} fst (toWitnessFalse{a? = 97 ≤? 40} tt)
unambiguousRange rightParen rightParen = refl
unambiguousRange rightParen (numbers (fst , snd)) =
  contradiction{P = 48 ≤ 41} fst (toWitnessFalse{a? = 48 ≤? 41} tt)
unambiguousRange rightParen (uppers (fst , snd)) =
  contradiction{P = 65 ≤ 41} fst (toWitnessFalse{a? = 65 ≤? 41} tt)
unambiguousRange rightParen (lowers (fst , snd)) =
  contradiction{P = 97 ≤ 41} fst (toWitnessFalse{a? = 97 ≤? 41} tt)
unambiguousRange plus plus = refl
unambiguousRange plus (numbers (fst , _)) =
  contradiction{P = 48 ≤ 43} fst (toWitnessFalse{a? = 48 ≤? 43} tt)
unambiguousRange plus (uppers (fst , snd)) =
  contradiction{P = 65 ≤ 43} fst (toWitnessFalse{a? = 65 ≤? 43} tt)
unambiguousRange plus (lowers (fst , snd)) =
  contradiction{P = 97 ≤ 43} fst (toWitnessFalse{a? = 97 ≤? 43} tt)
unambiguousRange comma comma = refl
unambiguousRange comma (numbers (fst , snd)) =
  contradiction{P = 48 ≤ 44} fst (toWitnessFalse{a? = 48 ≤? 44} tt)
unambiguousRange comma (uppers (fst , snd)) =
  contradiction{P = 65 ≤ 44} fst (toWitnessFalse{a? = 65 ≤? 44} tt)
unambiguousRange comma (lowers (fst , snd)) =
  contradiction{P = 97 ≤ 44} fst (toWitnessFalse{a? = 97 ≤? 44} tt)
unambiguousRange hyphen hyphen = refl
unambiguousRange hyphen (numbers (fst , snd)) =
  contradiction{P = 48 ≤ 45} fst (toWitnessFalse{a? = 48 ≤? 45} tt)
unambiguousRange hyphen (uppers (fst , snd)) =
  contradiction{P = 65 ≤ 45} fst (toWitnessFalse{a? = 65 ≤? 45} tt)
unambiguousRange hyphen (lowers (fst , snd)) =
  contradiction{P = 97 ≤ 45} fst (toWitnessFalse{a? = 97 ≤? 45} tt)
unambiguousRange period period = refl
unambiguousRange period (numbers (fst , snd)) =
  contradiction{P = 48 ≤ 46} fst (toWitnessFalse{a? = 48 ≤? 46} tt)
unambiguousRange period (uppers (fst , snd)) =
  contradiction{P = 65 ≤ 46} fst (toWitnessFalse{a? = 65 ≤? 46} tt)
unambiguousRange period (lowers (fst , snd)) =
  contradiction{P = 97 ≤ 46} fst (toWitnessFalse{a? = 97 ≤? 46} tt)
unambiguousRange fslash fslash = refl
unambiguousRange fslash (numbers (fst , snd)) =
  contradiction{P = 48 ≤ 47} fst (toWitnessFalse{a? = 48 ≤? 47} tt)
unambiguousRange fslash (uppers (fst , snd)) =
  contradiction{P = 65 ≤ 47} fst (toWitnessFalse{a? = 65 ≤? 47} tt)
unambiguousRange fslash (lowers (fst , snd)) =
  contradiction{P = 97 ≤ 47} fst (toWitnessFalse{a? = 97 ≤? 47} tt)
...
unambiguousRange (uppers (fst , snd)) (lowers (fst₁ , snd₁)) =
  contradiction{P = 97 ≤ 90} (≤-trans fst₁ snd) (toWitnessFalse{a? = 97 ≤? 90} tt)
...
unambiguousRange (lowers (fst , snd)) (numbers (fst₁ , snd₁)) =
  contradiction (≤-trans fst snd₁) (toWitnessFalse{a? = 97 ≤? 57} tt)
...
unambiguousRange (lowers (fst , snd)) (uppers (fst₁ , snd₁)) =
  contradiction (≤-trans fst snd₁) (toWitnessFalse{a? = _ ≤? _} tt)
