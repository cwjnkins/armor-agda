...
module Armor.Data.X690-DER.Sequence.Parser.Seq2
  {A B : @0 List UInt8 → Set} ⦃ _ : Eq≋ A ⦄
  {@0 bs' : List UInt8} (default : A bs') (loc : String)
  where

parseDefault₁
  :   @0 Unambiguous A → @0 NoSubstrings A → @0 NoConfusion A B
