...
module Armor.Data.X690-DER.Sequence.Parser.Seq6
  {A B C D E F : @0 List UInt8 → Set}
  ⦃ _ : Eq≋ B ⦄ ⦃ _ : Eq≋ C ⦄ ⦃ _ : Eq≋ E ⦄ ⦃ _ : Eq≋ F ⦄
  {@0 bs' bs'' bs''' bs'''' : List UInt8}
  (default₂ : B bs') (default₃ : C bs'') (default₅ : E bs''') (default₆ : F bs'''')
  (loc : String)
  where
...
runParser (parseOption₂Default₄ ua ns₁ ne₁ ub ns₂ ne₂ uc ns₃ ne₃ ud ns₄ ne₄ ue ns₅ ne₅ uf ns₆ ne₆ nc₁₂ nc₁₃ nc₁₄ nc₁₅ nc₁₆ nc₂₃ nc₂₄ nc₂₅ nc₂₆ nc₃₄ nc₃₅ nc₃₆ nc₄₅ nc₄₆ nc₅₆ pa pb pc pd pe pf n@(suc _)) xs = do
