...
instance
  EqTLV : ∀ {A : @0 List Dig → Set} ⦃ _ : Eq≋ A ⦄ → ∀ {t} → Eq≋ (TLV t A)
...
getLengthLen≡{t}{xs₁ = xs₁}{ys₁}{xs₂}{ys₂} ++≡ v₁ v₂
  with LengthProps.nonnesting (∷-injectiveʳ bs≡') (TLV.len v₁) (TLV.len v₂)
  where
  open ≡-Reasoning
...
... | refl = cong getLength (LengthProps.unambiguous (TLV.len v₁) (TLV.len v₂))
