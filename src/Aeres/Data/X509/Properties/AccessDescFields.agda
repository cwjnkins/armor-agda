...
equivalent : Equivalent (&ₚ (X509.AccessMethod) (GeneralName)) X509.AccessDescFields
...
iso : Iso (&ₚ (X509.AccessMethod) (GeneralName)) X509.AccessDescFields
proj₁ iso = equivalent
proj₁ (proj₂ iso) (mk&ₚ fstₚ₁ sndₚ₁ bs≡) = refl
proj₂ (proj₂ iso) (X509.mkAccessDescFields acmethod aclocation bs≡) = refl

@0 nonnesting : NonNesting X509.AccessDescFields
nonnesting x x₁ x₂ = NonNesting&ₚ AccessMethodProps.nonnesting GeneralName.nonnesting x (proj₂ equivalent x₁) (proj₂ equivalent x₂)

@0 unambiguous : Unambiguous X509.AccessDescFields
unambiguous =
  isoUnambiguous iso
    (unambiguous&ₚ AccessMethodProps.unambiguous
      AccessMethodProps.nonnesting GeneralName.unambiguous)
