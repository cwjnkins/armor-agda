...
chainToList₂ : ∀ {@0 bs} {trustedRoot candidates : List (Exists─ _ Cert)} (issuee : Cert bs)
  → Chain trustedRoot candidates issuee  → List (Exists─ (List UInt8) Cert)
chainToList₂ issuee (root (fst , snd)) = (_ , issuee) ∷ [ fst ]
chainToList₂ issuee (link issuer isIn x) = (_ , issuee) ∷ chainToList₂ issuer x
...
CCP3 : ∀ {@0 bs} {trustedRoot candidates : List (Exists─ _ Cert)} (issuee : Cert bs)
  → Chain trustedRoot candidates issuee → Set
CCP3 issuee c = CCP3Seq (reverse (chainToList₂ issuee c))

ccp3 : ∀ {@0 bs} {trustedRoot candidates : List (Exists─ _ Cert)} (issuee : Cert bs)
  → (c : Chain trustedRoot candidates issuee) → Dec (CCP3 issuee c)
ccp3 issuee c = CCP3Seq-dec (reverse (chainToList₂ issuee c))
  where
...
CCP4 : ∀ {@0 bs} {trustedRoot candidates : List (Exists─ _ Cert)} (issuee : Cert bs)
  → Chain trustedRoot candidates issuee → Set
CCP4 issuee c = helperCCP4 (chainToList₂ issuee c)

ccp4 : ∀ {@0 bs} {trustedRoot candidates : List (Exists─ _ Cert)} (issuee : Cert bs)
  → (c : Chain trustedRoot candidates issuee) → Dec (CCP4 issuee c)
ccp4 issuee c = helperCCP4-dec (chainToList₂ issuee c)
...
CCP5 : ∀ {@0 bs} {trustedRoot candidates : List (Exists─ _ Cert)} (issuee : Cert bs)
  → Chain trustedRoot candidates issuee → Set
CCP5 issuee c = List.Unique _≟_ (chainToList₂ issuee c)
...
CCP10 : ∀ {@0 bs} {trustedRoot candidates : List (Exists─ _ Cert)} (issuee : Cert bs)
  → Chain trustedRoot candidates issuee → Set
CCP10 issuee c = CCP10Seq (chainToList₂ issuee c)

ccp10 : ∀ {@0 bs} {trustedRoot candidates : List (Exists─ _ Cert)} (issuee : Cert bs)
  → (c : Chain trustedRoot candidates issuee) → Dec (CCP10 issuee c)
ccp10 issuee c = helper (chainToList₂ issuee c)
  where
