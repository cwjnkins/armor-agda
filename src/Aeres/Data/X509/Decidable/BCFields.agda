...
module parseBCFields where
  ...
  parseBCFieldsSeqFields n =
    parseEquivalent _ (equivalent×ₚ _ Props.BCFieldsSeqFields.equivalent)
      (parseOption₂ _ TLV.nonnesting TLV.nonnesting (TLV.noconfusion λ where ()) parseBool parseInt (tell $ here' String.++ ": underflow") _)
  ...
  parseBCFields = parseTLV _ "BC Fields" _ (parseExactLength _ TLV.nonnesting (tell $ here' String.++ ": underflow") parseBCFieldsSeq)
